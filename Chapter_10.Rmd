...
parameters_to_save <- c("L", "tau", "rho", "gamma12", "gamma23", "gamma13", "P11", "P12", "P13", "P22", "P23")
...
summary(results)['logh', c('mean', '2.5%', '97.5%')] %>% exp

```

From p 223: "The posterior mean hazard ratio is 0.525 with 95% credible interval (0.020, 1.04)".
These results are close except for the lower bound of the CI; could this be a typo in the book (0.20)?
